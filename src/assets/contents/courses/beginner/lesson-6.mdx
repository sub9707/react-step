export const metadata = {
  ...
  image: "/content/beginner/6/lesson-6-bg.png"
};
...
<ComparisonImages
  leftImage={{
    src: "/content/beginner/6/class-comp.png",
    alt: "클래스형 컴포넌트",
  }}
  rightImage={{
    src: "/content/beginner/6/function-comp.png",
    alt: "함수형 컴포넌트",
  }}
...
<Image
  src="/content/beginner/6/class-cycle.png"
  alt="클래스형 컴포넌트의 생명주기"
  width="full"
...
다음 회차에서는 React Hooks에 대해 더 자세히 알아보겠습니다.
</CalloutBox>