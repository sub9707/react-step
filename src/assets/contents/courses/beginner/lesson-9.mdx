export const metadata = {
  ...
  image: "/content/beginner/9/lesson-8-bg.png"
};
...
<Image
  src="/content/beginner/9/lesson-8-intro.gif"
  alt="데이터 흐름"
  width="two-thirds"
...
<ImageGallery
  images={[
    { src: '/content/beginner/9/react-query.png', alt: 'react-query' },
    { src: '/content/beginner/9/SWR.jpg', alt: 'SWR' },
    { src: '/content/beginner/9/apollo.png', alt: 'apollo' },
    { src: '/content/beginner/9/axios.png', alt: 'axios' },
  ]}
/>
