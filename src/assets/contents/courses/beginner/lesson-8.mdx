...
<ImageGallery
  images={[
    { src: '/content/beginner/8/react-query.png', alt: 'react-query' },
    { src: '/content/beginner/8/SWR.jpg', alt: 'SWR' },
    { src: '/content/beginner/8/apollo.png', alt: 'apollo' },
    { src: '/content/beginner/8/axios.png', alt: 'axios' },
  ]}
/>
