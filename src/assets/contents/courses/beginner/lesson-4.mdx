export const metadata = {
  ...
  image: "http://subdevpi.duckdns.org:3000/file/react-step/content/beginner/4/lesson-4-bg.png"
};
...
<Image
  src="http://subdevpi.duckdns.org:3000/file/react-step/content/beginner/4/JSX.png"
  alt="JSX 예시"
  width="half"
/>
<br/>
...
<CodeSandbox
title="JSX 내부에서 Javasciprt 표현식 사용"
code={`function App() {
...
export const jsxTernaryCode = `function App() {
...
<Image
  src="http://subdevpi.duckdns.org:3000/file/react-step/content/beginner/4/key-error.png"
  alt="key 오류 예시"
  width="two-thirds"
...
<CodeSandbox
  ...
  return (
    <div style={{display:"flex", flexDirection:"column", gap:'16px', width:'120px'}}>
      ...
      {/* 인라인 함수 */}
      <button onClick={() => alert('인라인 함수!')}>인라인 클릭</button>

      {/* 매개변수가 있는 함수 */}
      <button onClick={() => handleClick('매개변수')}>매개변수 전달</button>
