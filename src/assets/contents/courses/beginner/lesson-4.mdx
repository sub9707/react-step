export const metadata = {
  ...
  image: "/content/beginner/4/4_thumb.png"
};
...
<ComparisonImages
  leftImage={{
    src: "/content/beginner/4/brick-mold.png",
    alt: "벽돌틀",
  }}
  rightImage={{
    src: "/content/beginner/4/brick-house.png",
    alt: "벽돌로 집 짓기",
  }}
  height={'lg'}
/>
...
<br/>
<Image
  src="/content/beginner/4/component-example.png"
  alt="컴포넌트 개념 설명"
  width="full"
...
<br/>
<Image
  src="/content/beginner/4/props-component.png"
  alt="컴포넌트 Props 전달"
  width="two-thirds"
...
<Image
  src="/content/beginner/4/component-tree.png"
  alt="컴포넌트 계층 구조"
  width="two-thirds"
...
다음에는 컴포넌트가 어떻게 상태를 기억하고 변화하는지 알아보겠습니다.
</CalloutBox>