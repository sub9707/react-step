...
<Image
  src="/content/beginner/5/state-intro.gif"
  alt="state-intro"
  width="full"
...
<Image
  src="/content/beginner/5/state-cycle.png"
  alt="State 사이클 설명"
  width="full"
...
<br/>
<Image
  src="/content/beginner/5/react-flow.png"
...
<Image
  src="/content/beginner/5/usestate-hook.png"
  alt="useState 구조 분석"
  width="full"
...
<Image
  src="/content/beginner/5/state-update.png"
  alt="State 업데이트 과정"
  width="two-thirds"
...
<ImageGallery
  images={[
    { src: '/content/beginner/5/contextAPI.png', alt: '이미지1' },
    { src: '/content/beginner/5/redux.webp', alt: 'GIF 이미지'},
    { src: '/content/beginner/5/zustand.jpg', alt: '이미지3' },
    { src: '/content/beginner/5/recoil.png', alt: '이미지4' }
  ]}
/>
