export const metadata = {
  ...
  image: "/content/beginner/7/lesson-6-bg.png"
};
...
<ComparisonImages
  leftImage={{
    src: "/content/beginner/7/class-comp.png",
    alt: "클래스형 컴포넌트",
  }}
  rightImage={{
    src: "/content/beginner/7/function-comp.png",
    alt: "함수형 컴포넌트",
  }}
...
<Image
  src="/content/beginner/7/class-cycle.png"
  alt="클래스형 컴포넌트의 생명주기"
  width="full"
