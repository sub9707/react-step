export const metadata = {
  ...
  image: "/content/beginner/13/lesson-13-bg.png"
};
...
<Image
  src="/content/beginner/13/error_example.png"
  alt="chrome 에러 출력"
  width="two-thirds"
/>
...
<Image
  src="/content/beginner/13/consoleerror.png"
...
<Image
  src="/content/beginner/13/debugger-1.png"
  alt="chrome debugger"
  width="half"
...
<ImageGallery
  images={[
    { src: '/content/beginner/13/debugger-2.png', alt: 'debugger 실행 모습 1', caption: 'Sources 탭에서 breakpoint 설정' },
    { src: '/content/beginner/13/debugger-3.png', alt: 'debugger 실행 모습 2', caption: 'F10, F11 키로 단계별 실행' },
    { src: '/content/beginner/13/debugger-4.png', alt: 'debugger 실행 모습 3', caption: '우측의 탭에서 call stack과 현재 라인, 함수 정보와 반복문 등의 블록 정보를 확인 할 수 있다.' }
  ]}
/>
...
<Image
  src="/content/beginner/13/nodeconsole.png"
  alt="vscode debugger"
  width="half"
...
<Image
  src="/content/beginner/13/nodedebug.png"
  alt="vscode debugger"
  width="full"
...
<Image
  src="/content/beginner/13/reactdevtool.png"
...
<Image
  src="/content/beginner/13/devtool.png"
  alt="react devtool"
  width="full"
/>
